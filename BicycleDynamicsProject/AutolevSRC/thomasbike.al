...
Q6' = U6/R 
Q7' = U7/R
W_A1_N> = U3*A13> %ANGVEL(N,A1) Express(W_A1_N>,A1) explicit(W_A1_N>) 
W_A2_A1> = U4*A21>
...
solve(zero,u1',u4',u5')
constants u1_0
linu4dot = Taylor(rhs(u4'),0:1,q1,q2,q3,q4=0,q5=0,q6,q7,u1=u1_0,u4=0,u5=0)
linu5dot = Taylor(rhs(u5'),0:1,q1,q2,q3,q4=0,q5=0,q6,q7,u1=u1_0,u4=0,u5=0)
C94 = explicit(coef(linU4dot,q4))
C95 = explicit(coef(linU4dot,q5))
C99 = explicit(coef(linU4dot,u4))
C910 = explicit(coef(linU4dot,u5)) 
C104 = explicit(coef(linU5dot,q4))
C105 = explicit(coef(linU5dot,q5))
C109 = explicit(coef(linU5dot,u4))
C1010 = explicit(coef(linU5dot,u5))

C4 = 1
C3 = -c1010 - c99
C2 = c1010*c99 - c105 - c94 - c109*c910
C1 = c1010*c94 + c105*c99 - c104*c910 - c109*c95
C0 = c105*c94 - c104*c95
